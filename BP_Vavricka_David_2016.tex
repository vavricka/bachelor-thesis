...
Modul obsahuje pouze jeden parametr \uv{severity}, kterým se určuje nová severita zprávy. V případě zadání neplatné severity zaloguje Rsyslog chybovou hlášku a upravovaná zpráva zůstane v původním stavu.
