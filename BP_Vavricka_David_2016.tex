...
Na základě analýzy byl nasazen nový logovací démon Rsyslog, pro nějž byly naprogramovány dva moduly, dále bylo naprogramováno API umožňující změnu konfigurace logování a byly napsány podpůrné skripty.
...
Based on the results of the analysis was deployed Rsyslog logging daemon and were developed two Rsyslog modules, a new API for remote configuration change and some subsidiary scripts.

The new solution was tested on real hardware where were demonstrated accomplishment of all desired goals and good running characteristics.}
